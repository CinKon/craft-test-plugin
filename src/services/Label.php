...
class Label extends Component
{
    ...
    {
        return (string) Kittntestpluginfoo::$plugin->getSettings()->prefixText;
    }
    ...
    {
        return (string) Kittntestpluginfoo::$plugin->getSettings()->suffixText;
    }
    ...
    {
        return (string) Kittntestpluginfoo::$plugin->getSettings()->labelText;
    }
    ...
    {
        return (string) Kittntestpluginfoo::$plugin->getSettings()->labelColor;
    }
    ...
    {
        return (string) Kittntestpluginfoo::$plugin->getSettings()->textColor;
    }
    ...
    public function getJs(): string
    {
        ...
        $props = Kittntestpluginfoo::$plugin->getSettings()->getAttributes();
    ...
    {
        if (
            Kittntestpluginfoo::$plugin->getSettings()->showLabel
